...
def open_detail_window(result):
    from app.ui.windows.detail_window import DetailsWindow
...
def open_watchlist(self):
    from app.ui.windows.watchlist_window import WatchlistWindow
...
def open_portfolio(self):
    from app.ui.windows.portfolio_window import PortfolioWindow
