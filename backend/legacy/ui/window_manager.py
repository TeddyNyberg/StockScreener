...
def open_detail_window(result):
    from backend.legacy.ui.windows.detail_window import DetailsWindow
...
def open_watchlist(self):
    from backend.legacy.ui.windows.watchlist_window import WatchlistWindow
...
def open_portfolio(self):
    from backend.legacy.ui.windows.portfolio_window import PortfolioWindow
